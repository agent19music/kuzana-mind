/**
 * Editable Paddle catalog mapping (shared with marketing pricing).
 * Price IDs are public — safe in the client bundle. Live vs sandbox is
 * chosen from NEXT_PUBLIC_PADDLE_ENVIRONMENT at build time.
 */
